...
In 2017 I was diagnosed with a sarcoma. Caught early enough that I'm still here. But it was a near miss — my PCP almost didn't order the imaging that found it. Looking back, I got lucky. I can easily imagine alternate universes where the cancer wasn't caught, where I showed up too late, because no one pushed, because I didn't know to push, because the system is built for throughput not patient engagement.

I'm not building a tool that would have caught my cancer (the connection isn't that direct). But the experience made me care about health decisions in a way that's visceral rather than abstract. People make choices every day that put their health at risk — sometimes because they don't know the facts, sometimes because they know but don't believe, sometimes because they believe but can't act. Fifteen-minute appointments can't untangle all that.
