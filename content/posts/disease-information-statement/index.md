...
I wanted to include a chart comparing these two risks, but you can't draw it. One bar is 1 in 1,000. The other bar has no number. "Rarely" vs. "very remote" doesn't really convey this clearly, does it?
...
Perhaps the law should be re-amended to once again require a full account of just how bad the diseases in question are. But until then, there's nothing stopping pediatricians from voluntarily providing that information. I don't imagine there's a magic bullet here. Most people don't read this stuff anyway. But I think it matters on the margins that the official communication on these topics is, at least kinda passively, misleading about the risks.

[Calypta Health](https://app.calyptahealth.com/pub/flows/mmr-primary-series) offers one set of tools to help with this. Should we build Disease Information Statements, too, as supplements to the numberless VIS?
