...
{{< imgproc path="rivera-city-club.jpeg" command="resize 800x" alt="Diego Rivera fresco at the SF City Club" >}}

I love the whole thing, but especially the poppies:

{{< imgproc path="rivera-city-club-detail-poppy.jpeg" command="resize 800x" alt="Poppy detail from the Diego Rivera fresco" >}}