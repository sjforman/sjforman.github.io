...
The executive order makes a further change: pushing several routine childhood vaccines, including hepatitis B, rotavirus, flu, and COVID, into a category called "shared clinical decision-making." Under that label, a vaccine is no longer routinely recommended for everyone; instead, clinicians and their patients are supposed to weigh the decision together. Individual autonomy over one's own body is a foundational liberal principle, so the idea of classifying some of these vaccines as subject to "shared clinical decision making" sounds eminently reasonable. But the appealing name hides an unfortunate reality. We know what happens when we make this kind of change. Meningococcal B vaccination has been "shared clinical decision-making" since 2015, while MenACWY remained in the "routinely recommended" category. By 2022, MenB uptake was 29.4%, versus 90.7% for MenACWY. [As Jake Scott explains](https://jakescottmd.substack.com/p/when-the-default-is-inaction), the category was designed for genuine scientific uncertainty, and it's appropriate for that situation. But when the benefits of a vaccine vastly outweigh the risks, categorizing it as "shared clinical decision making" functions as de facto, and baseless, de-recommendation.

Whatever you think of that policy, in practice it will lead millions of parents to be told that these decisions are theirs to make, as a shared decision with a clinician they see for 15 minutes and who has five other topics to cover in that visit.[^time] And the parents never get a full and unflinching briefing on what the prevented diseases are *actually like*. They get a federally mandated Vaccine Information Statement, a legal document designed for consent, but one that doesn't even try to convey how bad the diseases are. We have consent, but in a deeper sense we're missing the *informed* part.
...
The health information miasma is not confined to the vaccine sphere. There's a cottage industry of grifters claiming statins are poison and that ivermectin cures cancer. Meanwhile 28 million American adults are eligible for statins and not taking them, 28 million are old enough for colorectal cancer screening and have never been screened, and 90 million are walking around with uncontrolled hypertension. The aggregate costs, in lost years of life and in dollars, are staggering.
